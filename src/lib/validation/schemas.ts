...
export const RequestPostApprovalSchema = z.object({
  post_id: UUIDSchema
})
...
export const RejectPostSchema = z.object({
  comment: z.string().max(500, 'Rejection comment is required').min(1)
})

export type RequestPostApprovalInput = z.infer<typeof RequestPostApprovalSchema>
...
export const UpdateABTestSchema = CreateABTestSchema.partial()

export const CreateABTestVariantSchema = z.object({
  test_id: UUIDSchema,
  post_id: UUIDSchema,
  variant_name: z.string().max(100).optional(),
...
export type CreateABTestVariantInput = z.infer<typeof CreateABTestVariantSchema>
